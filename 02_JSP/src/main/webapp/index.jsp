...
<html>
  ...
  <body>
    ...
    <p>
      JSP란 HTML문서내에 자바코드를 사용할 수 있도록 JPS용 코드를 제공.<br />
      Servlet(자바코드)에서 응답화면(HTML)을 구현했던 복잡함을 보다 간단하게
      해결 가능함.<br />
      => JSP의 가장 큰 장점은 Servlet에서는 요청처리(비즈니스로직)에만
      집중하고<br />
      응답화면만들기(프리젠테이션로직)는 JSP에서 집중하게 끔 분리할 수 있다는
      것.
    </p>
    <hr />
    ...
    <h3>
   		2. 지시어(Directive) <br>
   		&lt;@ page|include|talib 속성="속성값" 속성="속성값" &gt;
   	</h3>
   	<p>
   	<ol>
   		<li>
